...
//Desafio: Uma busca sequencial se caracteriza por percorrermos todos os  elementos de uma estrutura em busca do elemento “X” desejado. 
...
//Entrada:A entrada consiste em um valor de busca e/ou array
...
function busca(n) {
    ...
    if (elementos.indexOf(n) != -1) {
        console.log('Achei ' + valor + ' na posicao ' + elementos.indexOf(n));
    }
    else {
